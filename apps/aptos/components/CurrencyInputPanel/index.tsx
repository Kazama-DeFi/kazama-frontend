...
import { Currency, CurrencyAmount, Percent } from '@kazamaswap/aptos-swap-sdk'
import { useAccount, useAccountBalance } from '@kazamaswap/awgmi'
import { useIsMounted } from '@kazamaswap/hooks'
import { useCurrencyBalance } from 'hooks/Balances'
import useStablePrice from 'hooks/useStablePrice'
import { multiplyPriceByAmount } from 'utils/prices'
import { useTranslation } from '@kazamaswap/localization'
import { AtomBox, Button, ChevronDownIcon, CopyButton, Text, useModal } from '@kazamaswap/uikit'
