...
import { Trade, Currency, TradeType, CurrencyAmount } from '@kazamaswap/aptos-swap-sdk'
import { InjectedModalProps, LinkExternal, Text } from '@kazamaswap/uikit'
import { TransactionErrorContent, ConfirmationPendingContent } from '@kazamaswap/widgets-internal'
