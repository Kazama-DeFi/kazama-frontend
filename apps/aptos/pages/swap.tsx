import {
  ...
  Trade,
  TradeType,
} from '@kazamaswap/aptos-swap-sdk'
import { useAccount, useQuery } from '@kazamaswap/awgmi'
import { parseVmStatusError, SimulateTransactionError, UserRejectedRequestError } from '@kazamaswap/awgmi/core'
...
import { Swap as SwapUI, confirmPriceImpactWithoutFee } from '@kazamaswap/widgets-internal'

import replaceBrowserHistory from '@kazamaswap/utils/replaceBrowserHistory'
import tryParseAmount from '@kazamaswap/utils/tryParseAmount'
...
import { useIsExpertMode } from '@kazamaswap/utils/user/expertMode'
