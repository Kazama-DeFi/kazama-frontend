...
import { Button, Text, useModal, Box, Message, MessageText, AutoColumn, Dots } from '@kazamaswap/uikit'
import { confirmPriceImpactWithoutFee } from '@kazamaswap/widgets-internal'
import { useCallback, useEffect, useState, useMemo, memo } from 'react'
import { SMART_ROUTER_ADDRESSES, SmartRouterTrade } from '@kazamaswap/smart-router/evm'
