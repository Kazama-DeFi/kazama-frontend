...
import { Currency, CurrencyAmount, Token, TradeType } from '@kazamaswap/sdk'
import { ChainId } from '@kazamaswap/chains'

import { Box, BscScanIcon, Flex, InjectedModalProps, Link } from '@kazamaswap/uikit'
import {
  ApproveModalContent,
  SwapPendingModalContent,
  SwapTransactionReceiptModalContent,
} from '@kazamaswap/widgets-internal'
