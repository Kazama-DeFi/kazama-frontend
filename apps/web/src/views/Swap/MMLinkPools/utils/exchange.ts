import { Currency, CurrencyAmount, Fraction, Percent, Price, TradeType, ZERO_PERCENT } from '@kazamaswap/sdk'
...
import { RouteType, SmartRouterTrade } from '@kazamaswap/smart-router/evm'
