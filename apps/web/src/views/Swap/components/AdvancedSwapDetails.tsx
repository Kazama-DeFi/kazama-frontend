...
import { LegacyPair as Pair } from '@kazamaswap/smart-router/legacy-router'
import { Modal, ModalV2, QuestionHelper, SearchIcon, Text, Flex, Link, AutoColumn } from '@kazamaswap/uikit'
