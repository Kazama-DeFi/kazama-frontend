...
import { cakeVaultV2ABI } from '@kazamaswap/pools';
import { bscTokens } from '@kazamaswap/tokens';
import { Balance, Flex, Heading, Skeleton, Text, useMatchBreakpoints } from '@kazamaswap/uikit';
import {
    formatBigInt, formatLocalisedCompactNumber, formatNumber
} from '@kazamaswap/utils/formatBalance';
