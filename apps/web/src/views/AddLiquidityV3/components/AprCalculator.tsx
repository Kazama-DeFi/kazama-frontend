import { Currency, CurrencyAmount, Token, ZERO, Price } from '@kazamaswap/sdk'
import { TooltipText, Flex, CalculateIcon, Text, IconButton, QuestionHelper } from '@kazamaswap/uikit'
import {
  RoiCalculatorModalV2,
  RoiCalculatorPositionInfo,
  useRoi,
  useAmountsByUsdValue,
} from '@kazamaswap/widgets-internal/roi'
import { BIG_ZERO } from '@kazamaswap/utils/bigNumber'
import { encodeSqrtRatioX96, parseProtocolFees, Pool, FeeCalculator } from '@kazamaswap/v3-sdk'
import { useCallback, useMemo, useState } from 'react'
import { styled } from 'styled-components'
import { useTranslation } from '@kazamaswap/localization'
import { formatPrice } from '@kazamaswap/utils/formatFractions'
...
import { PositionDetails, getPositionFarmApr, getPositionFarmAprFactor } from '@kazamaswap/farms'
