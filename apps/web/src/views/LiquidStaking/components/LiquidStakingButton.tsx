...
import { Button, useToast, AutoRenewIcon } from '@kazamaswap/uikit'
import useAccountActiveChain from 'hooks/useAccountActiveChain'
import BigNumber from 'bignumber.js'
import { BIG_ZERO } from '@kazamaswap/utils/bigNumber'
import { masterChefV3Addresses } from '@kazamaswap/farms'
import { getDecimalAmount, getFullDisplayBalance } from '@kazamaswap/utils/formatBalance'
import { ToastDescriptionWithTx } from 'components/Toast'
import useCatchTxError from 'hooks/useCatchTxError'
import ConnectWalletButton from 'components/ConnectWalletButton'
import { LiquidStakingList } from 'views/LiquidStaking/constants/types'
import { Currency, CurrencyAmount, ERC20Token } from '@kazamaswap/sdk'
