...
import { Text, Flex, Box, Skeleton, TooltipText, useTooltip, IfoSkeletonCardDetails } from '@kazamaswap/uikit'
import { PublicIfoData, WalletIfoData } from 'views/Ifos/types'
import { useTranslation } from '@kazamaswap/localization'
import { Ifo, PoolIds } from '@kazamaswap/ifos'
import { BIG_ONE_HUNDRED } from '@kazamaswap/utils/bigNumber'
import { getBalanceNumber, formatNumber } from '@kazamaswap/utils/formatBalance'
import { useStablecoinPrice } from 'hooks/useBUSDPrice'
import { DAY_IN_SECONDS } from '@kazamaswap/utils/getTimePeriods'
