...
import {
  ...
  getDefaultProviders,
  defaultChains,
} from '@kazamaswap/awgmi';
import { PetraConnector } from '@kazamaswap/awgmi/connectors/petra'
import { MartianConnector } from '@kazamaswap/awgmi/connectors/martain'
...
import { FewchaConnector } from '@kazamaswap/awgmi/connectors/fewcha'
 ...
 // import { mainnet, testnet } from '@kazamaswap/awgmi/core'
...
## Connector
```jsx
import { useConnect, useDisconnect } from '@kazamaswap/awgmi'
...
### Send Transaction
```js
import { UserRejectedRequestError } from '@kazamaswap/awgmi'
