import { Currency, CurrencyAmount, Price, Token, ZERO, Percent, ZERO_PERCENT } from "@kazamaswap/sdk";
import { FeeAmount, FeeCalculator, TickMath, sqrtRatioX96ToPrice } from "@kazamaswap/v3-sdk";
import { useTranslation } from "@kazamaswap/localization";
import { useCallback, useMemo, useState } from "react";
import BigNumber from "bignumber.js";
import { BIG_ZERO } from "@kazamaswap/utils/bigNumber";
import { isPositionOutOfRange } from "@kazamaswap/utils/isPositionOutOfRange";
import { formatPercent, formatFraction, formatPrice } from "@kazamaswap/utils/formatFractions";

import { Button, DynamicSection, Flex, Message, MessageText, useMatchBreakpoints } from "@kazamaswap/uikit";

import { ScrollableContainer } from "@kazamaswap/uikit/components/RoiCalculatorModal/RoiCalculatorModal";
