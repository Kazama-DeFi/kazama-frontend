...
const getDisabledStyles = ({ $isLoading, theme }: TransientButtonProps) => {
  ...
  return `
    &:disabled,
    &.kazama-button--disabled {
      box-shadow: rgb(238 26 121 / 40%) 0px 0px 15px, rgb(255 255 255 / 20%) 0px 1px 0px inset, rgb(0 0 0 / 15%) 0px -3px 0px inset, ${theme.colors.backgroundDisabled} 0px 0px 12px inset;
