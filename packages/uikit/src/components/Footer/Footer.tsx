...
import {
    StyledFooter, StyledIconMobileContainer, StyledList, StyledListItem, StyledSocialLinks,
    StyledText, StyledToolsContainer
} from './styles';
...
const MenuItem: React.FC<React.PropsWithChildren<FooterProps>> = ({
  ...
  return (
    ...
    >
      <Flex flexDirection="column" width={["100%", null, "1125px;"]} px={['16px', '24px']} mx="auto">
