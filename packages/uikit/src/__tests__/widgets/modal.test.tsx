...
it("renders correctly", () => {
  ...
  expect(asFragment()).toMatchInlineSnapshot(`
    ...
    .c8:active:not(:disabled):not(.kazama-button--disabled):not(.kazama-button--disabled) {
      opacity: 0.85;
    ...
    @media (hover: hover) {
      .c8:hover:not(:disabled):not(.kazama-button--disabled):not(.kazama-button--disabled):not(:active) {
        opacity: 0.65;
      }
    }
