...
it("renders correctly", () => {
  ...
  expect(asFragment()).toMatchInlineSnapshot(`
    ...
    .c1:active:not(:disabled):not(.kazama-button--disabled):not(.kazama-button--disabled) {
      opacity: 0.85;
    ...
    @media (hover: hover) {
      .c1:hover:not(:disabled):not(.kazama-button--disabled):not(.kazama-button--disabled):not(:active) {
        opacity: 0.65;
      }
    }
