...
it("renders correctly with unit prop and switchEditingUnits", () => {
  ...
  expect(asFragment()).toMatchInlineSnapshot(`
    ...
    .c10:active:not(:disabled):not(.kazama-button--disabled):not(.kazama-button--disabled) {
      opacity: 0.85;
    ...
    @media (hover: hover) {
      .c10:hover:not(:disabled):not(.kazama-button--disabled):not(.kazama-button--disabled):not(:active) {
        opacity: 0.65;
      }
    }
