...
it("renders correctly", () => {
  ...
  expect(asFragment()).toMatchInlineSnapshot(`
    ...
    .c0:active:not(:disabled):not(.kazama-button--disabled):not(.kazama-button--disabled) {
      opacity: 0.85;
    ...
    @media (hover: hover) {
      .c0:hover:not(:disabled):not(.kazama-button--disabled):not(.kazama-button--disabled):not(:active) {
        opacity: 0.65;
      }
    }
