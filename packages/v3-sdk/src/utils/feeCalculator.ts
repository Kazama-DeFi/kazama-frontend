import { Currency, CurrencyAmount, MaxUint256, Percent, Fraction, ZERO } from '@kazamaswap/swap-sdk-core'
import invariant from 'tiny-invariant'
import { parseNumberToFraction } from '@kazamaswap/utils/formatFractions'
